		...
		try{
			...
			for(int count=1; rs.next(); count++){
				...
				if(count == (resultSetCount)){
					json+="{\"Complaint_No\":\""+Integer.toString(rs.getInt("Complaint_No"))+"\",\"CustomerId\":\""+rs.getString("CustomerId")+"\",\"Description\":\""+rs.getString("Description")+"\", \"Complaint_Date\":\""+rs.getString("Complaint_Date")+"\",\"Complaint_Status\":\""+rs.getBoolean("Complaint_Status")+"\"}";
				}else{
					json+="{\"Complaint_No\":\""+Integer.toString(rs.getInt("Complaint_No"))+"\",\"CustomerId\":\""+rs.getString("CustomerId")+"\",\"Description\":\""+rs.getString("Description")+"\", \"Complaint_Date\":\""+rs.getString("Complaint_Date")+"\",\"Complaint_Status\":\""+rs.getBoolean("Complaint_Status")+"\"},";
