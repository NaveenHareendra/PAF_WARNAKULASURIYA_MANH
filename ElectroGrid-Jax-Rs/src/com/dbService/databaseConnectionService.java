...
public class databaseConnectionService {
	...
	public boolean registerEmployeeDatabase(String empNic, String empAddress, String empEmail, String empName, String empPassword){
		int check=0;
		try{

			databaseConnection();
			
			 check=stmt.executeUpdate("INSERT INTO employeeInformation VALUES('"+empNic+ "','" + empName+ "','" + empAddress+ "','" +empEmail + "' ,'" + empPassword+ "')");
